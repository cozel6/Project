...
namespace Store.Repositories
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        {
            var updateCategory = storeContext.Categories.Update(category);
            storeContext.SaveChanges();
        ...
        {
            var deletede = storeContext.Categories.Remove(category);
        ...
        {
            return storeContext.Categories.All(x => x.Categoryname == categoryName);
        }

        public Category GetCategoryWithProducts(int id)
        {
            return storeContext.Categories.Include(x => x.Products).FirstOrDefault(x => x.Categoryid == id);
        }
    }
}
